...
temp = template_creation_utils.Dynamic
print(temp)
print(type(temp))
class SimpleAmpTemplate(TemplateMaster):#, metaclass=temp):
    __name__ = 'abc123'
